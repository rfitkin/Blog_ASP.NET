<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBlog.aspx.cs" Inherits="Githubapp.EditBlog" %>
...
<body>
    <form runat="server">
        ...
        <div style="margin-top:5px;">
            <asp:Button ID="editbtn" CssClass="buttonstyle buttonoption1" runat="server" Text="Edit Post" OnClick="editbtn_Click" />  
